...
- (void)viewDidLoad {
    ...
    UINavigationController * mainNavigationController = [MyUtil getViewControllerWithIdentifier:@"mainNavigation" storyboardName:@"Main"];
    
    UINavigationController * expensesNavigationController = [MyUtil getViewControllerWithIdentifier:@"Expenses" storyboardName:@"Expenses"];
    
    UINavigationController * addNavigationController = [MyUtil getViewControllerWithIdentifier:@"add" storyboardName:@"Add"];
    
    UINavigationController * grassNavigationController = [MyUtil getViewControllerWithIdentifier:@"Grass" storyboardName:@"Grass"];
    
    UINavigationController * myCenterNavigationController = [MyUtil getViewControllerWithIdentifier:@"myCenter" storyboardName:@"MyCenter"];
    
    self.viewControllers = @[mainNavigationController, expensesNavigationController, addNavigationController, grassNavigationController, myCenterNavigationController];
    ...
    addItem.selectedImage = [[UIImage imageNamed:@"add-s"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal];
